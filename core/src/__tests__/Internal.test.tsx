        ...
        await new BroTest.BroTest(
            (
                <div {...getTabsterAttribute({ root: {} })}>
                    <div id='element1'><button>Button1</button></div>
                    <div id='element2'><button>Button2</button></div>
                </div>
            )
        )
            .eval(() => {
                document.getElementById('element1')?.setAttribute('data-tabster', '{"groupper": {}}');
            })
            .eval(() => {
                const tabster = ((window as unknown) as WindowWithTabsterInternal).__tabsterInstance;
            ...
            .eval(() => {
                document.getElementById('element2')?.setAttribute('data-tabster', '{"groupper": {}}');
            })
            .eval((): string | void => {
                const tabster = ((window as unknown) as WindowWithTabsterInternal).__tabsterInstance;
                const el1 = document.getElementById('element1');
