...
export function createFocusedElementState(
    ...
    const api: FocusedElementStateInternal = {
        ...
        requestAsyncFocus(
            ...
            const nextAsyncFocus: AsyncFocus = {
                source,
                callback,
                timeout: setTimer(
                    undefined,
...
let _isTabbingTimer: Timer | undefined;
