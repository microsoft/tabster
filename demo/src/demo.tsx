...
ReactDOM.render(
    <div { ...AH.getAttribute({ root: true }) }>
        <div aria-label='Modal 1' { ...AH.getAttribute({ modalizer: { id: 'momo1'}, deloser: true }) }>
            <button>Hello</button>
            <button>Hello</button>
        </div>
        <div aria-label='Modal 2' { ...AH.getAttribute({ modalizer: { id: 'momo2'}, deloser: true }) }>
            <h1>Hello world</h1>
